...
import { sendToResumeQueue } from "../services/queueProducer.js";
  ...
  try {
    ...
    if (file) {
      ...
      if (cloudResponse && cloudResponse.secure_url) {
        ...
        // send to queue ONLY if resume changed
        if (oldResume !== cloudResponse.secure_url) {
          try {
            await sendToResumeQueue({
              userId: user._id,
              resumeUrl: cloudResponse.secure_url
            });
            console.log("Resume sent to queue");
          } catch (err) {
